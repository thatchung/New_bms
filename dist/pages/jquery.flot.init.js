...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var pcolors = ['#4bd396', '#f5707a','#ff8a00'];
		...
		var colors = ['#ff8a00', '#4bd396', "#f5707a", "#f9c851"];
		...
		var donutcolors = ['#ff9800', '#8d6e63', "#26a69a", "#ff8a00"];
		...
		this.createLineGraph("#line-chart-alt", line_ticks, ["#f5707a", "#ff8a00"], line_data);
	},
