          ...
          <tbody>
            <tr v-for="(item, index) in list_page.items" v-bind:key="index">
              ...
              <td class="text-center">
                <div v-if="profile.id == item.manager_id" class="btn btn-primary waves-effect waves-light m-b-20" @click="showEdit(item)" >
                  Cập nhật
                </div>
              </td>
            </tr>
        ...
        <model :is-open.sync="isShowAdd"
          ...
          <template v-slot:body>
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-9">
                  <select-list
                    ...
                    :value.sync="customer"
                    :searchname="'name'"
                    :name="'account/list?status=active&fix_role_id=3&manager_id='+ profile.id"
            ...
            <div class="row m-t-10">
              <div class="col-md-12">
                <div class="col-md-3">
                  <label for>Mã trang:</label>
                  <span class="text-danger">*</span>
                </div>
                <div class="col-md-9">
                  <el-input v-model="form.id_code" placeholder="Mã trang" clearable></el-input>
                </div>
              </div>
            </div>
            <div class="row m-t-10">
