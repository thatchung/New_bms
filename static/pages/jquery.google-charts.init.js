...
! function($) {
    ...
    GoogleChart.prototype.init = function () {
        ...
        $this.createColumnStackChart($('#column-stacked-chart')[0], column_stacked_data, 'Sales and Expenses', ['#ff8a00', '#4bd396', '#f9c851', '#f5707a', '#6b5fb5', '#3ac9d6']);
        ...
        $this.createBarStackChart($('#bar-stacked-chart')[0], bar_stacked_data, ['#ff8a00', '#4bd396', '#f9c851', '#f5707a', '#6b5fb5', '#3ac9d6']);
        ...
        $this.createPieChart($('#pie-chart')[0], pie_data, ['#ff8a00', '#4bd396', '#f9c851', '#f5707a', '#6b5fb5'], false, false);


        //creating donut chart
        $this.createDonutChart($('#donut-chart')[0], pie_data, ['#ff8a00', '#4bd396', '#f9c851', '#f5707a', '#6b5fb5']);

        //creating 3d pie chart
        $this.createPieChart($('#pie-3d-chart')[0], pie_data, ['#ff8a00', '#4bd396', '#f9c851', '#f5707a', '#6b5fb5'], true, false);
        ...
        $this.createPieChart($('#3d-exploded-chart')[0], sliced_Data, ['#ff8a00', '#4bd396', '#f9c851', '#f5707a', '#6b5fb5'], true, true);
